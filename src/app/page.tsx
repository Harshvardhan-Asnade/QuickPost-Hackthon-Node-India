...
export default function LandingPage() {
  return (
    <div className="flex flex-col min-h-screen bg-transparent text-gray-800">
      <header className="px-4 lg:px-6 h-20 flex items-center sticky top-0 z-50 bg-white/60 backdrop-blur-lg border-b border-white/20">
        ...
        <nav className="ml-auto flex gap-4 sm:gap-8 items-center">
          ...
          <Button variant="ghost" className="hidden sm:inline-flex text-primary hover:bg-primary/10 hover:text-primary">
              Login
          </Button>
          <Button asChild className="bg-primary hover:bg-primary/90 text-primary-foreground rounded-full shadow-lg hover:shadow-xl transition-shadow">
            <Link href="#">
        ...
        <section className="w-full pt-20 md:pt-32 lg:pt-40 pb-12 md:pb-24 lg:pb-32">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center space-y-6 text-center">
              ...
              >
                <h1 className="text-4xl font-extrabold tracking-tighter sm:text-5xl md:text-6xl lg:text-7xl/none bg-clip-text text-transparent bg-gradient-to-r from-primary via-blue-500 to-teal-400">
              ...
              >
                <Button asChild size="lg" className="bg-primary hover:bg-primary/90 text-primary-foreground rounded-full shadow-lg hover:shadow-xl transition-shadow">
        ...
        <section id="features" className="w-full py-12 md:py-24 lg:py-32">
            <div className="container px-4 md:px-6">
                ...
                <div className="mx-auto grid max-w-5xl items-start gap-8 sm:grid-cols-2 md:grid-cols-3">
                    <AnimatedSection>
                        <Card className="glass-card transition-all duration-300 transform hover:-translate-y-2 hover:shadow-2xl">
                    ...
                    <AnimatedSection>
                        <Card className="glass-card transition-all duration-300 transform hover:-translate-y-2 hover:shadow-2xl">
                             <CardHeader className="flex flex-row items-center gap-4">
                                ...
                                <CardTitle className="text-foreground">Audience Targeting</CardTitle>
                            </CardHeader>
                            <CardContent className="text-muted-foreground">
                     ...
                     <AnimatedSection>
                        <Card className="glass-card transition-all duration-300 transform hover:-translate-y-2 hover:shadow-2xl">
                             <CardHeader className="flex flex-row items-center gap-4">
                                ...
                                <CardTitle className="text-foreground">Time-Saving Efficiency</CardTitle>
                            </CardHeader>
                            <CardContent className="text-muted-foreground">
            ...
            <AnimatedSection>
                <div className="container grid items-center justify-center gap-4 px-4 text-center md:px-6">
                    <div className="space-y-3">
                        <h2 className="text-3xl font-bold tracking-tighter md:text-4xl/tight bg-clip-text text-transparent bg-gradient-to-r from-primary via-blue-500 to-teal-400">
